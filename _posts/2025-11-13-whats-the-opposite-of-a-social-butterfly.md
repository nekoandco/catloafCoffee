...
![chat bubble, butterfly, and heartbreak emojis]({{site.baseurl}}/assets/images/sadBitchHour/socialButterflyHeader.png)

<div class="alert alert-danger" role="alert">⚠️ lengthy discussion of suicide</div>
  <div class="card">
      ...
      <div class="card-body">
      	<ol type="i">
        	<li><a href="#august">August</a></li>
       		...
       		<li><a href="#the-day-after">The day after</a></li>
       	</ol>
      </div>
    </div>
<br>
...
After a little while, Luna asks if I’m ready to order and I say yes. I order a Neapolitan spaghetti[^1] and she orders some veggie thing. An awkward silence follows, which means that I must be bombing this social interaction because a long time ago I got it in my head that I am destined to carry the entire weight of any conversation I’m ever a part of. It’s not you, it’s me. It’s *always* me.
